...
SYSTEM_PROMPT = (
    ...
    "and your job is to investigate the application source code, find the root cause, "
    "and apply a minimal fix.\n\n"
    "Follow these steps:\n"
    "1. List the repository files to understand the project structure\n"
    "2. Read the relevant source files (start with main application files)\n"
    "3. Search for patterns related to the error described in the alert\n"
    "4. Determine the root cause of the issue\n"
    "5. Apply a fix using the apply_fix tool — provide the complete updated file content\n\n"
...
async def fix_alert(payload: FixRequest):
    ...
    try:
        ...
        if not diff.stdout.strip():
            ...
            return {"status": "no_fix_needed", "analysis": analysis}
        ...
        return {"status": "pr_created", "pr_url": pr_url, "analysis": analysis}
