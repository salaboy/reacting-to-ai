    ...
    <div className="desktop">
      ...
      <div className="phone">
        ...
        <div className="phone-top-bezel">
          ...
          <div className="phone-brand">HomeBanking&trade; PDA</div>
        </div>

        {/* Phone Screen — contains the entire Win95 UI */}
        <div className="phone-screen" onClick={() => setShowStartMenu(false)}>
          {/* Win95 Window */}
          <div className="win95-window">
            ...
            {/* Bottom nav bar (replaces toolbar for mobile) */}
            <div className="bottom-nav">
              <button
                className={`bottom-nav-btn ${view === 'accounts' ? 'nav-active' : ''}`}
                onClick={() => { setView('accounts'); setSelectedAccount(null) }}
              >
              ...
              <button
                className={`bottom-nav-btn ${view === 'transfer' ? 'nav-active' : ''}`}
              ...
              <button
                className={`bottom-nav-btn ${view === 'support' ? 'nav-active' : ''}`}
                onClick={() => { setView('support'); setSupportResult(null) }}
              >
                <span className="nav-icon">&#128222;</span>
                <span className="nav-label">Support</span>
              </button>
              <button className="bottom-nav-btn" onClick={fetchAccounts}>
                <span className="nav-icon">&#128260;</span>
